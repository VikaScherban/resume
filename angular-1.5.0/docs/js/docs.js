...
.directive('docTutorialNav', function() {
  ...
  return {
    ...
    template:
      ...
      '<a ng-href="http://angular.github.io/angular-phonecat/step-{{seq}}/js"><li class="btn btn-primary"><i class="glyphicon glyphicon-play"></i> Live Demo</li></a>\n' +
  ...
  return {
    ...
    template:
      ...
      '  <p>Refresh your browser or check out this step online: '+
          '<a href="http://angular.github.io/angular-phonecat/step-{{step}}/js">Step {{step}} Live Demo</a>.</p>\n' +
      '</div>\n' +
